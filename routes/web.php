...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('gestion-estudiantes', function () {
		return view('pages.gestion-estudiantes');
	...
	Route::get('gestion-administradores', function () {
		return view('pages.gestion-administradores');
...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::post('profile', ['as' => 'profile.updateAvatar', 'uses' => 'ProfileController@updateAvatar']);
